...
final class Hooks_Registrar {
	 ...
	 * @param Asset_Manager_Interface   $asset_manager The service for asset management.
	 */
	public function __construct(
		...
		private Asset_Manager_Interface $asset_manager,
	) {}
	...
	public function enqueue_assets( string $hook ): void {
		...
		$this->asset_manager->enqueue( $this->definition );
	}
