...
final class Plugin_Settings_Tabbed {
    ...
    public function init(): void {
        ...
        $page = ( new Settings_Builder() )->create(
            self::OPTION_NAME,
            self::PAGE_SLUG
        );
     ...
     */
    private function add_structure( Settings_Page $page ): void {
        // Tabs
        ...
        $page->add_section(
            'text_section',
            'Text & Number Inputs',
            'Fields for various text-based and numeric data.',
            'basic_tab'
        );
        $page->add_section(
            'toggle_section',
            'Toggles & Pickers',
            'Boolean switches and color selection.',
            'basic_tab'
        );
        ...
        $page->add_section(
            ...
            'Fields for selecting one option from a list.',
            'choice_tab'
        );
        $page->add_section(
            'multiple_choice_section',
            'Multiple Choice Fields',
            'Fields for selecting multiple options from a list.',
            'choice_tab'
        );
        $page->add_section(
            'conditional_choice_section',
            'Conditional Fields',
            'These fields appear based on the settings above.',
            'choice_tab'
        );
        ...
        $page->add_section(
            'editor_section',
            'Editors',
            'Fields for rich text and code.',
            'content_tab'
        );
        $page->add_section(
            'media_section',
            'Media Library',
            'Fields for selecting items from the WordPress Media Library.',
            'content_tab'
        );
        ...
        $page->add_section(
            'post_relationship_section',
            'Post Relationships',
            'Link to posts, pages, or custom post types.',
            'relationship_tab'
        );
        $page->add_section(
            'user_term_relationship_section',
            'User & Term Relationships',
            'Link to users and taxonomy terms.',
            'relationship_tab'
        );
    }
     ...
     * @param Settings_Page $page The settings page instance.
     */
    private function add_basic_fields( Settings_Page $page ): void {
        // Text & Number Section
        $page->add_field(
            'text_field',
            'text_section',
            ...
            'Site Name',
            [
                'description' => 'A standard input for single-line text.',
            ]
        );
        $page->add_field(
            'url_field',
            ...
            'Site URL',
            [
                'description' => 'Input for URLs, sanitized with <code>esc_url_raw()</code>.',
            ]
        );
        $page->add_field(
            'email_field',
            ...
            'Admin Email',
            [
                'description' => 'Input for a valid email address.',
            ]
        );
        $page->add_field(
            'number_field',
        ...
        $page->add_field(
            ...
            'API Key',
            [
                'description' => 'A secure field for sensitive data. Value is not shown in HTML.',
            ]
        );
        ...
        $page->add_field(
            ...
            'Primary Color',
            [
                'description' => 'Uses the native WordPress color picker.',
                'default'     => '#0073aa',
            ]
        );
    }
     ...
     *
     * @param Settings_Page $page
     */
    private function add_choice_fields_with_conditions( Settings_Page $page ): void {
     ...
     * @param Settings_Page $page The settings page instance.
     */
    private function add_content_fields( Settings_Page $page ): void {
        // Editors Section
        $page->add_field(
            'textarea_field',
            'editor_section',
            ...
            [
                'description'     => 'A field for multi-line text.',
        ...
        $page->add_field(
            ...
            'Welcome Message',
            [
                'description'     => 'The classic WordPress rich text editor.',
                'editor_settings' => [
                    'textarea_rows' => 8,
                    'media_buttons' => true,
                ],
        ...
        $page->add_field(
            ...
            'Custom CSS',
            [
                'description' => 'A syntax-highlighting editor for CSS.',
                'mode'        => 'text/css',
            ]
        );
        ...
        $page->add_field(
            ...
            [
                ...
                'media_settings' => [ 'library_type' => 'image' ],
            ]
        );
        $page->add_field(
            ...
            'Image Gallery',
            [
                'description' => 'Select multiple items from the Media Library.',
            ]
        );
    }
     ...
     * @param Settings_Page $page The settings page instance.
     */
    private function add_date_time_fields( Settings_Page $page ): void {
        ...
        $page->add_field(
            ...
            'Event Date',
            [
                'description'    => 'Stores date as <code>Y-m-d</code>. <code>display_format</code> changes the view.',
        ...
        $page->add_field(
            ...
            'Opening Time',
            [
                'description'    => 'Stores time as <code>H:i:s</code>.',
        ...
        $page->add_field(
            ...
            'Campaign Start',
            [
                'description'    => 'Stores date and time as <code>Y-m-d H:i:s</code>.',
                'display_format' => 'M j, Y @ h:i K',
            ]
        );
        ...
        $page->add_field(
            ...
            'Promotion Duration',
            [
                'description'    => 'Stores a start and end date as a JSON array.',
                'display_format' => 'M d',
            ]
        );
        $page->add_field(
            ...
            'Maintenance Window',
            [
                'description'    => 'Stores a start and end date/time as a JSON array.',
                'display_format' => 'M d, h:i K',
            ]
        );
    }
     ...
     * @param Settings_Page $page The settings page instance.
     */
    private function add_relationship_fields( Settings_Page $page ): void {
        ...
        $page->add_field(
            ...
            '',
            [
                'description' => 'These fields use AJAX to search for WordPress objects. Use <code>query_args</code> to filter the results.',
            ]
        );
        $page->add_field(
            'post_field',
            ...
            'Featured Page',
            [
                'description' => 'Select a single Page.',
        ...
        $page->add_field(
            ...
            'Related Articles',
            [
                'description' => 'Select multiple Posts.',
        ...
        $page->add_field(
            ...
            'Relevant Tags',
            [
                'description' => 'Select multiple post tags.',
